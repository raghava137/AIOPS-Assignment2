"""Generates the deterministic 1,000-message spam/ham dataset.

Taken from the assignment brief unchanged, so the CSV is identical for anyone
who runs it. Writes spam_dataset.csv in the current directory.
"""
...
print(f"Wrote spam_dataset.csv with {len(rows)} rows")
